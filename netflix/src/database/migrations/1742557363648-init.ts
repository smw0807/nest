...
export class Init1742557363648 implements MigrationInterface {
  name = 'Init1742557363648';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "movie" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "version" integer NOT NULL, "id" SERIAL NOT NULL, "name" character varying NOT NULL, "movieFilePath" character varying, "rating" numeric(3,1) NOT NULL, "year" integer NOT NULL, "likeCount" integer NOT NULL DEFAULT '0', "dislikeCount" integer NOT NULL DEFAULT '0', "actors" text array NOT NULL, "directorId" integer NOT NULL, "detailId" integer NOT NULL, "creatorId" integer, CONSTRAINT "UQ_cee7125f3cbad047d34a6e13539" UNIQUE ("name"), CONSTRAINT "REL_87276a4fc1647d6db559f61f89" UNIQUE ("detailId"), CONSTRAINT "PK_cb3bb4d61cf764dc035cbedd422" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
